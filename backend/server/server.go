...
func (server *Server) SetupRoutes() {
	...
	//users
	server.initializeUserRoutes(apiGroup)

	//listings
	server.initializeListingRoutes(apiGroup)

	//bids
	server.initializeBidRoutes(apiGroup)
...
func (server *Server) initializeUserRoutes(apiGroup *gin.RouterGroup) {
...
func (server *Server) initializeListingRoutes(apiGroup *gin.RouterGroup) {
